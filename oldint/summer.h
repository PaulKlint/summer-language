...
struct file {
	...
	char		fl_buffer[1];	/* the data buffer */
};
...
#define	Sr		Sstring[3]
#define	Sw		Sstring[4]
#define	Srw		Sstring[5]
#define	Squote		Sstring[6]
#define	Snl		Sstring[7]
#define	Serror		Sstring[8]
#define	Squestion	Sstring[9]
#define	Slayout		Sstring[10]
#define	Ssemi		Sstring[11]
#define	Sdigit		Sstring[12]
#define Slbrack		Sstring[13]
#define Srbrack		Sstring[14]
#define Sslash		Sstring[15]
#define Sletgit		Sstring[16]
#define Scomma		Sstring[17]
#define Sdollar		Sstring[18]
#define Sequal		Sstring[19]
#define Splusminus	Sstring[20]
#define Scolon		Sstring[21]
#define Splus		Sstring[22]
#define Sminus		Sstring[23]
#define Speriod		Sstring[24]
#define Sexclam		Sstring[25]
#define Ssubject	Sstring[26]
#define Sself		Sstring[27]
#define Swhere		Sstring[28]
#define Soff		Sstring[29]
#define Sstack		Sstring[30]
#define Sletter		Sstring[31]
#define Scalls		Sstring[32]
#define Sall		Sstring[33]
struct string *Sstring[34];
...
#define SZ_FILE		(SZ_SUMDP+8*SZ_INTVAL)
...
#define	NCACHE	1600				/* max # of cache values */
struct cache cachemem [NCACHE];
